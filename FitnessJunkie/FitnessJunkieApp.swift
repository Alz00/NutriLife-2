...
struct BottomTabBar: View {
    @Binding var selectedTab: Int
    @State private var showScanMealView = false
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                ...
                TabBarItem(icon: "camera", text: "Scan Meal", isSelected: false)
                    .onTapGesture { showScanMealView = true }
        ...
        .sheet(isPresented: $showScanMealView) {
            ScanMealView(selectedTab: $selectedTab)
        }
    }
}
...
// Add this new struct to your existing FitnessJunkieApp.swift file
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                // Camera icon and Take Photo button
                VStack(spacing: 20) {
                ...
                // Back button
                Button(action: {
                    selectedTab = 1 // Set the selected tab to Home (Dashboard)
